...
class ZonesController extends AppController
{
	...
	public function view($id = null)
	{
		$this->Zone->id = $id;
		if (!$this->Zone->exists()) {
			$this->Session->setFlash(__('Invalid zone.'), 'Default/Flash/error');
	...
	public function add()
	{
		if ($this->request->is('post')) {
			...
			if ($this->Zone->save($this->request->data)) {
				$this->Session->setFlash(__('The zone has been saved'), 'Default/Flash/success');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The zone could not be saved. Please, try again.', 'Default/Flash/error'));
	...
	public function edit($id = null)
	{
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			if ($this->Zone->save($this->request->data)) {
				$this->Session->setFlash(__('The zone has been updated.'), 'Default/Flash/information');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The zone could not be saved. Please, try again.', 'Default/Flash/error'));
				$this->redirect($this->referer());
	...
	public function delete($id = null)
	{
		...
		if ($this->Zone->delete()) {
			$this->Session->setFlash(__('Zone deleted'), 'Default/Flash/default');
			$this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__('Zone was not deleted'), 'Default/Flash/error');
		$this->redirect(array('action' => 'index'));
	}
