...
class UserGroupsController extends AppController
{
	...
	public function view($id = null)
	{
		...
		if (!$this->UserGroup->exists()) {
			$this->Session->setFlash(__('Invalid user group.'), 'Default/Flash/error');
	...
	public function add()
	{
		if ($this->request->is('post')) {
			...
			if ($this->UserGroup->save($this->request->data)) {
				$this->Session->setFlash(__('The user group has been saved'), 'Default/Flash/success');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The user group could not be saved. Please, try again.', 'Default/Flash/error'));
	...
	public function edit($id = null)
	{
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			if ($this->UserGroup->save($this->request->data)) {
				$this->Session->setFlash(__('The user group has been updated.'), 'Default/Flash/information');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The user group could not be saved. Please, try again.', 'Default/Flash/error'));
				$this->redirect($this->referer());
	...
	public function delete($id = null)
	{
		...
		if ($this->UserGroup->delete()) {
			$this->Session->setFlash(__('User group deleted'), 'Default/Flash/default');
			$this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__('User group was not deleted'), 'Default/Flash/error');
		$this->redirect(array('action' => 'index'));
	}
