				...
				<button class="btn" type="button">
					<?php
						echo $this->Form->postLink($this->Html->image('fugue-icons/cross-button.png',
							...
							array('controller' => 'warehouses', 'action' => 'delete', 'manager' => true, $this->data['Warehouse']['id']),
							array('escape' => false),
							__('Are you sure you want to delete # %s?', $this->data['Warehouse']['id'])
						);
					?>
				</button>
			</div>
				...
				<button class="btn" type="button">
					<?php
						echo $this->Html->link($this->Html->image('fugue-icons/magnifier.png',
							...
							array('controller' => 'warehouses', 'action' => 'view', 'manager' => true, $this->data['Warehouse']['id']),
							array('escape' => false)
						);
					?>
				</button>
	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo __('Edit # ') . $this->data['Warehouse']['id']; ?></li>
			</ul>
		</div>
	</div>
