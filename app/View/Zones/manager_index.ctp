	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo __('Zones'); ?></li>
			</ul>
		</div>
	</div>
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<tr>
				<td class="icon">
					<?php
						echo $this->Form->input('Zone.id_' . $zone['Zone']['id'],
							array('type' => 'checkbox', 'label' => '', 'value' => $zone['Zone']['id'])
						);
					?>
				</td>
				<td class="id"><?php echo h($zone['Zone']['id']); ?></td>
				...
				<td class="actions">
					<?php
						echo $this->Html->link($this->Html->image('fugue-icons/document.png',
							...
							array('controller' => 'zones', 'action' => 'view', $zone['Zone']['id']),
							array('escape' => false)
						);
